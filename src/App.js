  ...
  return (
    <div className="App">
      ...
      <div className="experience-header">
        <h3 className="experience-title">Receet</h3>
        <span className="experience-location">Gurugram, Haryana</span>
      </div>
      <div className="experience-meta">
        <span className="experience-role">Software Engineer Intern</span>
        <span className="experience-duration">Aug 2025 – Jan 2026</span>
      </div>
        <ul className="experience-list">
          <li>&bull;&nbsp; Built the mobile application in React Native with improved UI and app performance.</li>
          <li>&bull;&nbsp; Integrated Setu Account Aggregator APIs for secure content-based across to user financial data.</li>
          <li>&bull;&nbsp; Developed a finance web application using React for user onboarding and transaction management.</li>
          <li>&bull;&nbsp; Collaborated with teams to deliver new features and resolve bugs quickly.</li>
        </ul>
      </div>
